        ...
        <section className=" h-full flex flex-col gap-5">
            <div className="text-center">
                ...
                <div>
                    ...
                    <Input {...register('password')} type='password' id='password' className='mt-2' placeholder='************' />
                ...
                <div>
                    ...
                    <Input {...register('confirmPassword')} type='password' id='confirmPassword' className='mt-2' placeholder='************' />
